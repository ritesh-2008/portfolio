...
const skillCategories = [
  ...
  },
  {
    ...
    icon: '🖥️',
    color: 'accent',
    skills: ['React', 'Next.js', 'Tailwind CSS', 'TypeScript', 'Framer', 'Bootstrap', "JavaScript", 'chakra ui'],
  ...
  },
  {
    ...
    icon: '🛠️',
    color: 'primary',
    skills: ['Git', 'Docker', 'Linux', 'VSCode','remix', 'Postman', 'GitHub Actions', 'MongoDb Compass'],
